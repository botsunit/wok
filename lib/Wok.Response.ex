# File: Wok.Response.ex
# This file was generated from wok_response.beam
...
defmodule Wok.Response do
  ...
  def unquote(:"set_headers")(arg1, arg2) do
    :erlang.apply(:"wok_response", :"set_headers", [arg1, arg2])
  end
  def unquote(:"merge_headers")(arg1, arg2) do
    :erlang.apply(:"wok_response", :"merge_headers", [arg1, arg2])
  end
end

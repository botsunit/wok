...
3. Reference your services and routes in the `config` file (see [Configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#conf))
...
* `messages :: list()` : [Messages configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#messages_conf)

* `rest :: list()` : [REST configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#rest_conf)
...
* `services :: list()` : [Services configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#services_conf)
...
* `topics :: list()` : [Topics configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#topic_conf)
...
* `routes :: list()` : [Routes configuration](https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/README.md#routes_conf)
...
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/wok.md" class="module">wok</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/wok_request.md" class="module">wok_request</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/wok_response.md" class="module">wok_response</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/adapter/doc/wok_routes.md" class="module">wok_routes</a></td></tr></table>

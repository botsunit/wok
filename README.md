...
3. Reference your services and routes in the `config` file (see [Configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#conf))
...
* `messages :: list()` : [Messages configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#messages_conf)

* `rest :: list()` : [REST configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#rest_conf)
...
* `services :: list()` : [Services configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#services_conf)
...
* `topics :: list()` : [Topics configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#topic_conf)
...
* `routes :: list()` : [Routes configuration](https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/README.md#routes_conf)
...
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/wok.md" class="module">wok</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/wok_message.md" class="module">wok_message</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/wok_message_handler.md" class="module">wok_message_handler</a></td></tr>
<tr><td><a href="https://gitlab.botsunit.com/msaas/wok/tree/async_catch/doc/wok_producer.md" class="module">wok_producer</a></td></tr></table>
